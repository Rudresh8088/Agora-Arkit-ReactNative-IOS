...
class ViewController: UIViewController, UITextFieldDelegate {
  ...
  var storyBoard : UIStoryboard = UIStoryboard(name: "ViewController", bundle:nil)
  ...
  // Create a local session by remote user
  func createSessionHost(_ channelName: String) {
    let arBroadcastVC = ARSupportBroadcasterViewController()
    arBroadcastVC.channelName = channelName
    arBroadcastVC.modalPresentationStyle = .fullScreen
  ...
  // Join the Remotecall
  func joinRemoteSessionCheck(_ channelName: String) {
    let arSupportVC = ARSupportAudienceViewController()
    arSupportVC.channelName = channelName
    arSupportVC.modalPresentationStyle = .fullScreen
    if let vc = self.storyboard?.instantiateViewController(withIdentifier: "ViewController") as? ViewController {
